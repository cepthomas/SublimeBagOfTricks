...
#     pr__int("unloading plugin", modulename)
...
#     pr__int("reloading plugin", modulename)
...
#                 pr__int(override_py, 'could not be read:', e)
...
#             except (Exception) as e:
#                 pr__int(override_init, 'could not be read:', e)
...
#                         pr__int(f, "in", self.zippath, "is not utf-8 encoded, unable to load plugin")
#                         continue
...
#         except (Exception) as e:
#             pr__int("Error loading %s:" % self.zippath, e)
