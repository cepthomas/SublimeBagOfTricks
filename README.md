...
A work-in-progress sublime 3 plugin containing a bunch of things I use but are missing from other packages.
The focus is not on code development but rather text processing.
Also an excuse to update my python.
...
# SublimePluginTemplate
A kitchen sink of ST3 plugin capabilities. Basically accumulated learnings while figuring out how to build them for another project. Not really a template per se.

Built on Windows and ST3 but most should adapt easily to other OSes and ST2.
